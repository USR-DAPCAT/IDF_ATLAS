...
- Determinar la prevalencia de diabetis por grupos de edad, sexo y ruralidad por subgrupos<br/>
...
```{r rangs_edat, include=TRUE, results="asis"}
...
genera_output<-function(x="2010",dt=dt_colapsat) {
  ...
  dt_temp<-dt %>% filter(sexe=="Female" & edat.cat2<="[45-50)")
...
rep("2010":"2018") %>% purrr::map(~genera_output(.x,dt_colapsat)) %>% invisible()
